...
outfl_1 = pd.read_csv(r"outfl_1.csv", header=None)
outfl_2 = pd.read_csv(r"outfl_2.csv", header=None)
outfl_3 = pd.read_csv(r"outfl_3.csv", header=None)
outfl_4 = pd.read_csv(r"outfl_4.csv", header=None)
