/*
* This header declares the class ExplicitCompositionalBestEffortSynthesizer
* which implements the explicit-compositional approach to best-effort synthesis
*/

#ifndef SYFT_EXPLICITCOMPOSITIONALBESTEFFORTSYNTHESIZER_H
#define SYFT_EXPLICITCOMPOSITIONALBESTEFFORTSYNTHESIZER_H
...
namespace Syft {
	...
	class ExplicitCompositionalBestEffortSynthesizer {
		...
		public:
			...
			* 
			*/
            ExplicitCompositionalBestEffortSynthesizer(std::shared_ptr<VarMgr> var_mgr,
