/*
* This header declares the class AdversarialSynthesizer
* which implements reactive synthesis under environment assumptions
* by reducing it to reactive synthesis
*/

#ifndef SYFT_ADVERSARIALSYNTHESIZER_H
#define SYFT_ADVERSARIALSYNTHESIZER_H
...
namespace Syft {
	...
	class AdversarialSynthesizer {
		...
		public:
			...
			* 
			*/
			AdversarialSynthesizer(std::shared_ptr<VarMgr> var_mgr,
